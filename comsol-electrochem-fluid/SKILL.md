...
```powershell
python "$env:USERPROFILE\.agents\skills\comsol-electrochem-fluid\scripts\find_examples.py"
python "$env:USERPROFILE\.agents\skills\comsol-electrochem-fluid\scripts\find_examples.py" --keyword electrolyzer --keyword pem
python "$env:USERPROFILE\.agents\skills\comsol-electrochem-fluid\scripts\find_examples.py" --module Electrochemistry_Module --module CFD_Module --keyword bubbly
python "$env:USERPROFILE\.agents\skills\comsol-electrochem-fluid\scripts\find_examples.py" --module Corrosion_Module --keyword localized
```
...
- Read [references/coupling-verification.md](references/coupling-verification.md) for **battle-tested lessons on verifying TCD + Bubble Flow couplings, hardcoded-uncoupling audits, MassActionLaw i0_ref constraints, and packed-vector gravity traps** (from a Cu electrowinning project, 2026-06).
